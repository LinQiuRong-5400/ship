...
export default class jigsawPuzzle1_1 extends puremvc.Component {
    ...
    __start () {
        ...
        let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/gk_20_dock_2.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/gk_20_dock_2.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/gk_20_dock_2.atlas';
        GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"gk_20_dock_2.png",(err,res)=>{
        ...
        // '/gk_20_dock_2', sp.SkeletonData,(err,res)=>{
        //     if( err ) console.log( "ship_prefab load err" , err );
        //     if( err ) return ;
        //     let node = new cc.Node("end_animation");
        //     node.parent = self.node;
