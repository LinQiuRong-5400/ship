...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t8_1_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t8_1_dock_1.atlas';
        ...
        // '/t8_1_dock_1', sp.SkeletonData,(err,res)=>{
    ...
    shipAni_DriveIn()
    {
        ...
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("enter","g8_dredger"); // 音效
