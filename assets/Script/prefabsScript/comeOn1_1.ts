...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        // 加载骨骼动画
        let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/g13_dock_1.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/g13_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/g13_dock_1.atlas';
        GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"g13_dock_1.png",(err,res)=>{
        ...
        // '/g13_dock_1', sp.SkeletonData,(err,res)=>{
    ...
    shipAni_DriveIn()
    {
        ...
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("enter","g13_backhoe_dredger"); // 音效
    ...
    shipAni_DriveOut()
    {
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("out","g13_backhoe_dredger"); // 音效
