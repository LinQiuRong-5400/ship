...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ 5 +'/t4_1_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ 5 +'/t4_1_dock_1.atlas';
