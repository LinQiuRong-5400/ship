...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        // 加载骨骼动画
        let imageUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 4 +'/t10_sep_01.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 4 +'/t10_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 4 +'/t10_dock_1.atlas';
        ...
        // cc.loader.loadRes("Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 4 +
