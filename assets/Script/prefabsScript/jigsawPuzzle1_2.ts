...
let self ;
@ccclass
export default class jigsawPuzzle1_2 extends puremvc.Component {
    ...
    __start () {
        ...
        // https://shipbuild.obs.cn-south-1.myhuaweicloud.com/Checkpoint_ani/big_checkpoint1/small_checkpoint1/g13_dock_2.png
        // https://shipbuild.obs.cn-south-1.myhuaweicloud.com/Checkpoint_ani/big_checkpoint1/small_checkpoint2/t5_dock_2.png

        let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t5-t7_t12_sep_01.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t5_dock_2.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t5_dock_2.atlas';
        GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"t5-t7_t12_sep_01.png",(err,res)=>{
        ...
        // '/t5_dock_2', sp.SkeletonData,(err,res)=>{
        //     if( err ) console.log( "ship_prefab load err" , err );
        //     if( err ) return ;
        //     let node = new cc.Node("end_animation");
        //     node.parent = self.node ;
    ...
    end_animation()
    {
        ...
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("out","g5_crane_ship"); // 音效
        ...
        end_skeleton.setAnimation( 0,"dock_liftdown",false );
