...
export default class shipWashing1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        // 加载骨骼动画 
        let imageUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 6 +'/t11_sep_01.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 6 +'/t11_dock_2.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 6 +'/t11_dock_2.atlas';
        ...
        // cc.loader.loadRes("Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 6 + 
