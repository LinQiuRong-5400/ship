...
export default class jigsawPuzzle1_2 extends puremvc.Component {
    ...
    __start () {
        ...
        let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t10_sep_01.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t10_dock_2.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t10_dock_2.atlas';
        GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"t10_sep_01.png",(err,res)=>{
        ...
        // '/t10_dock_2', sp.SkeletonData,(err,res)=>{
        //     if( err ) console.log( "ship_prefab load err" , err );
        //     if( err ) return ;
        //     let node = new cc.Node("end_animation");
        //     node.parent = self.node ;
    ...
    end_animation()
    {
        ...
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("out","g10_container_ship"); // 音效
