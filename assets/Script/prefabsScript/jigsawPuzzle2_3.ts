...
export default class jigsawPuzzle1_1 extends puremvc.Component {
    ...
    __start () {
        ...
        // let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_1_sep_01.png';
        ...
        // GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"t_3_1_sep_01.png",(err,res)=>{
