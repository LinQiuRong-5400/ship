...
export default class shipWashing1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        let skeUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 2 +'/t5_dock_2.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 2 +'/t5_dock_2.atlas';
