...
export default class work1 extends puremvc.Component {
    ...
    loadSpSkeleton () {
        ...
        {
            let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/g11_stage_6.png';
            let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/g11_stage_6.json';
            let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/g11_stage_6.atlas';
            GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"g11_stage_6.png",(err,res)=>{
            ...
            imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/home_6.png';
            skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/home_6.json';
            atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/home_6.atlas';
            GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"home_6.png",(err,res)=>{
                    if( err ) console.log( "ship_prefab load err" , err );
                    if( err ) return ;
                    console.log("lqr loaderSkeleton ok !")
        ...
        else
        {
            ...
            cc.loader.loadRes("Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +
                '/g11_stage_6', sp.SkeletonData,(err,res)=>{
            ...
            // 小岛
            cc.loader.loadRes("Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +
                '/home_6', sp.SkeletonData,(err,res)=>{
                if( err ) console.log( "Checkpoint2 g3_2_barge_ load err" , err );
                if( err ) return ;
                let node = new cc.Node("stage_1");
                node.parent = self.node ;
    ...
    Init()
    {
        ...
        if( this.Ani_Model == 1 )
        {
            ...
            g13_backhoe_dredger.setAnimation( 0,"stage6_action_1",false );
            g13_backhoe_dredger.setCompleteListener(function(){
                self.isClick_flag = true ;
                g13_backhoe_dredger.setAnimation( 0,"stage6_idle_1",true );
            ...
            stage_1.setAnimation( 0,"stage6_action_1",false );
            stage_1.setCompleteListener(function(){
                stage_1.setAnimation( 0,"stage6_idle_1",true );
            });
            // 水 stage_2_waterline
        ...
        else if( this.Ani_Model == 2 )
        {
            ...
            let g13_backhoe_dredger = this.g13_backhoe_dredger.getComponent(sp.Skeleton);
            g13_backhoe_dredger.node.active = true ;
            g13_backhoe_dredger.setAnimation( 0,"stage6_action_2",false );
            g13_backhoe_dredger.setCompleteListener(function(){
                self.isClick_flag = true ;
                g13_backhoe_dredger.setAnimation( 0,"stage6_idle_2",true );
                GameManger.Instacne.AudioEngine.playActionAudioByUrl(big_checkpoint,small_checkpoint,0); // 音效
            });
            // 小岛 stage_1
            let stage_1 = this.stage_1.getComponent(sp.Skeleton);
            stage_1.node.active = true ;
            stage_1.setAnimation( 0,"stage6_action_2",false );
            stage_1.setCompleteListener(function(){
                stage_1.setAnimation( 0,"stage6_idle_2",true );
            });    
        } 
        else if( this.Ani_Model == 3 )
        {
            ...
            let g13_backhoe_dredger = this.g13_backhoe_dredger.getComponent(sp.Skeleton);
            g13_backhoe_dredger.node.active = true ;
            g13_backhoe_dredger.setAnimation( 0,"stage6_action_3",false );
            g13_backhoe_dredger.setCompleteListener(function(){
                self.Ani_Model ++ ;
                self.Init();
                // g13_backhoe_dredger.setAnimation( 0,"stage4_idle_3",true );
                // self.isClick_flag = true ;
            });
            // 小岛 stage_1
            let stage_1 = this.stage_1.getComponent(sp.Skeleton);
            stage_1.node.active = true ;
            stage_1.setAnimation( 0,"stage6_action_3",false );
            stage_1.setCompleteListener(function(){
                stage_1.setAnimation( 0,"stage6_idle_3",true );
            });
        } 
        else if( this.Ani_Model == 4 )
        {
            ...
            let g13_backhoe_dredger = this.g13_backhoe_dredger.getComponent(sp.Skeleton);
            g13_backhoe_dredger.node.active = true ;
            g13_backhoe_dredger.setAnimation( 0,"stage4_action_4",false );
            g13_backhoe_dredger.setCompleteListener(function(){
            ...
            let stage_1 = this.stage_1.getComponent(sp.Skeleton);
            stage_1.node.active = true ;
            stage_1.setAnimation( 0,"stage4_action_4",false );
            stage_1.setCompleteListener(function(){
