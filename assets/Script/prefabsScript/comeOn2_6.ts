...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        let skeUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 6 +'/t11_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+1+"/small_checkpoint"+ 6 +'/t11_dock_1.atlas';
