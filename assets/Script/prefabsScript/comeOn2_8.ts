...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        // 加载骨骼动画
        let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_2_sep_01.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_2_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_2_dock_1.atlas';
        GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"t_3_2_sep_01.png",(err,res)=>{
        ...
        // '/t_3_2_dock_1', sp.SkeletonData,(err,res)=>{
    ...
    shipAni_DriveIn()
    {
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("enter","g7_blue_barge"); // 音效
    ...
    shipAni_DriveOut()
    {
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("out","g7_blue_barge"); // 音效
