...
export default class shipWashing1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        // 加载骨骼动画 
        let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/gk_21_dock_2.png';
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/gk_21_dock_2.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/gk_21_dock_2.atlas';
        GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"gk_21_dock_2.png",(err,res)=>{
        ...
        // '/gk_21_dock_2', sp.SkeletonData,(err,res)=>{
