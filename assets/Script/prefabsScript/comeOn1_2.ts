...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t5_dock_1.json';
        let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t5_dock_1.atlas';
        ...
        // '/t5_dock_1', sp.SkeletonData,(err,res)=>{
    ...
    shipAni_DriveIn()
    {
        GameManger.Instacne.AudioEngine.playShipAudioByUrl("enter","g5_crane_ship"); // 音效
