...
export default class comeOn1 extends puremvc.Component {
    ...
    __onLoad()
    {
        ...
        // 加载骨骼动画
        // let imageUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_1_dock_1.png';
        // let skeUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_1_dock_1.json';
        // let atlasUrl = "Checkpoint_ani/big_checkpoint"+big_checkpoint+"/small_checkpoint"+ small_checkpoint +'/t_3_1_dock_1.atlas';
        // GameManger.Instacne.loaderSkeleton(imageUrl,skeUrl,atlasUrl,"t_3_1_dock_1.png",(err,res)=>{
        ...
        '/t_3_1_dock_1', sp.SkeletonData,(err,res)=>{
